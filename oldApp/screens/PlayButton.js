...
import {View, StyleSheet, Pressable, Image, Dimensions, Vibration, ActivityIndicator} from 'react-native';
...
function PlayButton({props}) {
    ...
    function CallApi(setTitleNow, titleNow, setCoverAlbum, setArtistNow, artistNow,
                     trackArtist, setStartedAt, startedAt, setEndAt, endAt, setDuration, duration) {
        axios(
            baseUrl,
        ).then((response) => {
